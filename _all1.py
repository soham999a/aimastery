...
# ── 1. Update lesson page with YouTube embed + certificate button ──
lesson_code = '''"use client";
...
'''
with open("ar-ai-mastery/app/courses/[slug]/learn/page.tsx", "w", encoding="utf-8") as f:
    f.write(lesson_code)
print("lesson page updated with YouTube + certificate")
