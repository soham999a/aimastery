...
os.makedirs("ar-ai-mastery/app/courses/[slug]/classroom", exist_ok=True)

classroom_page = '''"use client";
...
with open("ar-ai-mastery/app/courses/[slug]/classroom/page.tsx", "w", encoding="utf-8") as f:
    f.write(classroom_page)
print("classroom page done", os.path.getsize("ar-ai-mastery/app/courses/[slug]/classroom/page.tsx"))
