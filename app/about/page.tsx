...
const TEAM = [
  { name: "Debopriyo Ghoshal", role: "Founder & CEO", initials: "DG", grad: ["#1e3a8a", "#2563eb"], bio: "Visionary behind YesDo Edutech. Building India's most practical AI education platform from Kolkata." },
